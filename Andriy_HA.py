...
print("для найкращої ітераціЇ: номер, абсолютна похибка, двійковий індивід, значення невідомих:" )
print(gener)
print(minimum)
print(element)
print(toAB(getX(element)))
print()
print("для останньої ітераціЇ: номер, абсолютна похибка, двійковий індивід, значення невідомих:" )
print(lastmin)
print(lastelem)
print(toAB(getX(lastelem)))

# Іноді точність дуже хороша, іноді дуже погана... Якщо збільшити ймовірність мутації, то,
...
# при поточній схемі (глобальне схрещування) добре помітна хаотичність результатів: покращуючи
# одне значення, алгоритм схрещування часто погіршує інші, тому помітна така значна девіація
